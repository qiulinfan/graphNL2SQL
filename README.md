...
└── Train_Test.ipynb         # Jupyter notebook for experiments
```
...
- **Exact Match (EM)**: Predicted SQL exactly matches gold SQL
- **Execution Accuracy (EX)**: Predicted SQL produces correct results when executed
- **Join Accuracy (JAcc)**: Correctly predicted JOIN relationships
